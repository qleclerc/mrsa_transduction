...
models_to_try = data.frame(model_name="tr_dde_fit_frequentist_decay_link_both", frequentist=TRUE,
                                 second_beta = F,
                                 delay=TRUE, 
...
saveRDS(all_theta, here::here("Fitting", "10_3", "best_params_transduction3.rds"))
