...
refPars <- data.frame(best = c(0.31, 60, 1, 0.67, 0.72, 90),
...
likelihood <- function(par, mode = "pow"){
...
names(median_params) = c("beta", "L", "alpha", "tau", "pow")
...
ggsave(here::here("Fitting", "pow_fitted.png"), pp)
saveRDS(out, here::here("Fitting", "pow_fitted_out.rds"))
